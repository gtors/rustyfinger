...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _FpiDeviceAes3500 {
    pub parent: FpiDeviceAes3k,
}
pub type FpiDeviceAes3500 = _FpiDeviceAes3500;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct FpiDeviceAes3500Class {
...
#[no_mangle]
pub unsafe extern "C" fn fpi_device_aes3500_get_type() -> GType {
    ...
    {
        let mut g_define_type_id: GType = fpi_device_aes3500_get_type_once();
...
static mut fpi_device_aes3500_parent_class: gpointer = 0 as *const libc::c_void
    as *mut libc::c_void;
static mut FpiDeviceAes3500_private_offset: gint = 0;
unsafe extern "C" fn fpi_device_aes3500_class_intern_init(mut klass: gpointer) {
    fpi_device_aes3500_parent_class = g_type_class_peek_parent(klass);
    if FpiDeviceAes3500_private_offset != 0 as libc::c_int {
        g_type_class_adjust_private_offset(klass, &mut FpiDeviceAes3500_private_offset);
    }
    fpi_device_aes3500_class_init(klass as *mut FpiDeviceAes3500Class);
}
#[inline(never)]
unsafe extern "C" fn fpi_device_aes3500_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        fpi_device_aes3k_get_type(),
        g_intern_static_string(
            b"FpiDeviceAes3500\0" as *const u8 as *const libc::c_char,
        ),
        ::core::mem::size_of::<FpiDeviceAes3500Class>() as libc::c_ulong as guint,
        ::core::mem::transmute::<
        ...
        >(
            ...
            >(
                Some(
                    fpi_device_aes3500_class_intern_init
                        as unsafe extern "C" fn(gpointer) -> (),
                ),
            ),
        ),
        ::core::mem::size_of::<FpiDeviceAes3500>() as libc::c_ulong as guint,
        ::core::mem::transmute::<
            Option::<unsafe extern "C" fn() -> ()>,
            GInstanceInitFunc,
        >(
            ::core::mem::transmute::<
                Option::<unsafe extern "C" fn(*mut FpiDeviceAes3500) -> ()>,
                Option::<unsafe extern "C" fn() -> ()>,
            >(
                Some(
                    fpi_device_aes3500_init
                        as unsafe extern "C" fn(*mut FpiDeviceAes3500) -> (),
                ),
            ),
        ),
        G_TYPE_FLAG_NONE,
            ...
            c2rust_unnamed: C2RustUnnamed_0 {
                c2rust_unnamed: {
                    let mut init = C2RustUnnamed_3 {
                        pid: 0x5731 as libc::c_int as guint,
...
unsafe extern "C" fn fpi_device_aes3500_init(mut self_0: *mut FpiDeviceAes3500) {}
unsafe extern "C" fn fpi_device_aes3500_class_init(
    mut klass: *mut FpiDeviceAes3500Class,
) {
    ...
    (*dev_class).id = b"aes3500\0" as *const u8 as *const libc::c_char;
    (*dev_class).full_name = b"AuthenTec AES3500\0" as *const u8 as *const libc::c_char;
    (*dev_class).id_table = id_table.as_ptr();
    (*img_class).img_height = 128 as libc::c_int * 2 as libc::c_int;
    (*img_class).img_width = 128 as libc::c_int * 2 as libc::c_int;
    (*aes_class).data_buflen = 0x2089 as libc::c_int as gsize;
    (*aes_class).frame_width = 128 as libc::c_int as gsize;
    (*aes_class)
        .frame_size = (128 as libc::c_int * 16 as libc::c_int / 2 as libc::c_int)
        as gsize;
    (*aes_class).frame_number = (128 as libc::c_int / 16 as libc::c_int) as gsize;
    (*aes_class).enlarge_factor = 2 as libc::c_int as gsize;
