...
static mut crc_table: [uint16_t; 256] = [
...
#[no_mangle]
pub unsafe extern "C" fn udf_crc(
    ...
    loop {
        ...
        crc = ((crc as libc::c_int) << 8 as libc::c_int
            ^ crc_table[(crc as libc::c_int >> 8 as libc::c_int & 0xff as libc::c_int
                ^ *fresh1 as libc::c_int) as usize] as libc::c_int) as uint16_t;
    }
    return crc;
}
